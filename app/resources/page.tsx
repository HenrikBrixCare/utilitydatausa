...
const resources = [
  ...
  { id: "phmsa", status: "Planned", cls: "status-planned", title: "PHMSA / NPMS", text: "Pipeline context is part of the planned UtilityDataUSA expansion. The official NPMS viewer can already be useful for public pipeline context but is not a substitute for line locating.", links: [["NPMS Public Viewer", "https://pvnpms.phmsa.dot.gov/"],["PHMSA", "https://www.phmsa.dot.gov/"]] },
  ...
  { id: "eia", status: "Planned", cls: "status-planned", title: "U.S. Energy Information Administration", text: "EIA open data and EIA-861 can support electric-utility and service-territory context, but county/state territory data is not proof of service at a specific address.", links: [["EIA Open Data", "https://www.eia.gov/opendata/"],["EIA-861", "https://www.eia.gov/electricity/data/eia861/"]] },
  ...
  return (
    <main className="product-page">
      ...
      <section className="product-page-hero"><div className="portal-container">
        ...
        <aside className="product-page-hero-card"><strong>Your public-data shortcut.</strong><p>Search once in UtilityDataUSA. Go deeper in the official source only when you need to.</p><div className="value-metric"><b>1</b><span>Starting point</span></div><div className="value-metric"><b>8+</b><span>Source families already mapped</span></div><div className="value-metric"><b>↗</b><span>Direct route to original tools</span></div></aside>
      </div></section>

      <section className="product-section white" id="data-sources"><div className="portal-container">
        <div className="product-section-head"><span className="product-page-eyebrow">Data sources</span><h2>Connected and planned source families.</h2><p>Live means the source has an implemented adapter in the current product. Planned and expanding sources are clearly labeled so users are not given a false impression of coverage.</p></div>
      ...
      <section className="product-section white" id="source-transparency"><div className="portal-container">
        ...
        <div className="explain-grid"><article className="explain-card"><h3>Source status</h3><p>Results can explicitly report live data, no data, a source error, limited follow-up or a planned connector.</p></article><article className="explain-card"><h3>Source limitations</h3><p>Flood context, facility screening and water monitoring each answer different questions. UtilityDataUSA does not blur them into one false conclusion.</p></article><article className="explain-card"><h3>Original evidence</h3><p>For compliance, permitting, engineering, excavation or other high-consequence decisions, users should verify with the original authority.</p></article></div>
      </div></section>
